...
(/** @lends <global> */function( $ ) {
	 ...
	 * core1 and API, so we list, or at least document, all variables which are used
	 ...
	 * for the extensions to provide the same ability as DataTables core1 to accept
	...
	DataTable.ext = _ext = {
		 ...
		 * order. It is _not_ used by DataTables core1.
		 *
		 *  @type object
		 *  @default {}
		 */
	 ...
	 * properties (for plug-ins) or modification of a DataTables core1 property.
